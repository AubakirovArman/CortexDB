...
- release-to-release coverage for `v0.1.0-core-alpha.5 -> v0.2.0-beta.2`,
  including restore, API, SDK, and storage gates.
...
historical restore fixture currently covers `v0.1.0-core-alpha.5` and the
explicit beta compatibility pair `v0.1.0-core-alpha.5 -> v0.2.0-beta.2`.
