...
| MultiHop-RAG local run | Official MultiHop-RAG retrieval evaluator over full 2556-query dataset: `Hits@10=0.9902`, `Hits@4=0.9295`, `MAP@10=0.4503`, `MRR@10=0.7906`; DeepSeek Flash QA with official `qa_evaluate.py`: overall `F1=0.74`, `Accuracy=0.66`; no leaderboard claim. |
