...
- tasks:
  ...
  - [ ] 4) partial: AQL/get/search materialize payload through `Database::payload_for_version`; graph/session/temporal/tool/synonym/context expansion stores still need lazy-aware hydration or descriptor/index-backed design
