...
| Distributed replication | frozen | `EPIC-F02`; code is excluded from default engine builds behind Cargo feature `experimental-replication`, and runtime activation is separately default-off. No HA product claim until unfreeze criteria are met. | [`ENGINE_FEATURE_FLAGS.md`](ENGINE_FEATURE_FLAGS.md), [`DATABASE_GRADE_EXECUTION_PLAN.md`](DATABASE_GRADE_EXECUTION_PLAN.md), [`FUTURE_NON_GOAL_EPICS.md`](FUTURE_NON_GOAL_EPICS.md) |
