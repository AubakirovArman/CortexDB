...
| ANN fixture gate | `make ann-fixture-check` and `make ann-drift-check` pass; CI uploads `target/ann/ann_fixture_report.json` and `target/ann/ann_drift_report.json`. |
