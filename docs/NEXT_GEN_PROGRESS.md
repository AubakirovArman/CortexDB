...
and corpus-backfill embedding paths are usable end-to-end today, but the plan's
A2.1/A2.2 also require embedding-profile provenance in the manifest and
checkpoint/HNSW interaction proofs before the embedding capability is
contract-grade. Those remain future work and are tracked in the *Not yet*
columns above.
