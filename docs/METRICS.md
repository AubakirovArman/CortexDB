...
| `cortexdb_request_timeout_total` | Prometheus-only counter for requests that hit a configured route timeout. | Any increase means a client or route exceeded the read/write/admin timeout budget. |
