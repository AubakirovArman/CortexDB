...
- dedicated recall, MRR, nDCG, and latency trend panels;
...
- recall, MRR, nDCG, and p95 latency trend panels are generated by a
  self-tested static dashboard renderer;
