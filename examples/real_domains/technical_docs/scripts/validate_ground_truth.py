#!/usr/bin/env python3
"""Validate technical_docs queries and ground-truth references."""
...
def main() -> int:
    ...
    print(f"technical_docs ground truth valid: queries={len(query_ids)} rows={len(truth_rows)}")
    return 0
...
if __name__ == "__main__":
    try:
        ...
        print(f"technical_docs ground truth validation failed: {error}", file=sys.stderr)
        raise SystemExit(1)
