#!/usr/bin/env python3
"""Validate support_tickets queries and ground-truth references."""
...
def main() -> int:
    ...
    print(f"support_tickets ground truth valid: queries={len(query_ids)} rows={len(truth_rows)}")
    return 0
...
if __name__ == "__main__":
    try:
        ...
        print(f"support_tickets ground truth validation failed: {error}", file=sys.stderr)
        raise SystemExit(1)
