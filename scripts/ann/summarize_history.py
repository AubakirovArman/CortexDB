...
def load_run(manifest_path: Path) -> dict[str, Any]:
    ...
    run = {
        ...
        "mean_mrr_q16": as_int_default(report.get("mean_mrr_q16"), 0),
        "mean_ndcg_q16": as_int_default(report.get("mean_ndcg_q16"), 0),
        "exact_parity_q16": as_int_default(report.get("exact_parity_q16"), 0),
        "exact_parity_count": as_int_default(report.get("exact_parity_count"), 0),
...
def compare_adjacent(
    ...
    *,
    ...
    checks = [
        ...
        ("mean_mrr_q16", "ranking"),
        ("mean_ndcg_q16", "ranking"),
        ("exact_parity_q16", "exact_parity"),
...
class SelfTests(unittest.TestCase):
    def write_run(self, root: Path, run_id: str, recall: int, p95: int, safe: bool) -> None:
        ...
        report = {
            ...
            "mean_recall_q16": recall,
            "mean_mrr_q16": recall,
            "mean_ndcg_q16": recall,
            "exact_parity_q16": recall,
