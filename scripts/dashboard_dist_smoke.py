...
def main() -> int:
    ...
    required = [
        ...
        ("permissions report", "permissions-report" in index),
        ("read-only mode", "read-only-mode" in index and "guardWriteAllowed" in script),
        ("operational status", "status-report" in index and "dashboard_status.v1" in script),
