...
REQUIRED_MARKERS = {
    "persisted_auth_policy_store": [
        ...
        ("docs/SECURITY_HARDENING_EVIDENCE.md", "rbac_policy_store_gate: true"),
    ...
    "per_principal_quota": [
        ...
        ("docs/SECURITY_HARDENING_EVIDENCE.md", "quota_policy_gate: true"),
    ...
    "audit_chain_foundation": [
        ...
        ("docs/SECURITY_HARDENING_EVIDENCE.md", "audit_chain_gate: true"),
