...
REQUIRED_MARKERS = {
    ...
    "alerts": [
        ...
        ("examples/observability/alerts.yml", "CortexDbActorQueueWaitP95High"),
        ("examples/observability/alerts.yml", "CortexDbDatabaseBusy"),
        ("examples/observability/alerts.yml", "CortexDbOperationalErrorRateHigh"),
        ("examples/observability/alerts.yml", "CortexDbRateLimitSpike"),
        ("examples/observability/alerts.yml", "CortexDbBackupStale"),
        ("examples/observability/alerts.yml", "CortexDbBackupEvidenceMissing"),
        ...
        ("examples/observability/alerts.yml", "cortexdb_backup_latest_age_seconds"),
        ("examples/observability/alerts.yml", "cortexdb_principal_quota_requests_rejected"),
        ("examples/observability/alerts.yml", "cortexdb_principal_quota_body_bytes_rejected"),
        ("examples/observability/alerts.yml", "cortexdb_principal_quota_queue_rejected"),
        ("docs/archive/OBSERVABILITY_ALERTS.md", "Suggested Actions"),
        ("docs/archive/OBSERVABILITY_ALERTS.md", "Operational Error Rate"),
        ("docs/archive/OBSERVABILITY_ALERTS.md", "Rate-limit Spike"),
        ("docs/archive/OBSERVABILITY_ALERTS.md", "Backup Evidence"),
    ],
    "docs": [
        ...
        ("docs/archive/METRICS_CONTRACT_V2.md", "metrics-contract-v2-check"),
        ("docs/archive/OBSERVABILITY_EVIDENCE.md", "make observability-check"),
    ],
}
