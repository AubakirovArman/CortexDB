#!/usr/bin/env python3
"""Multi-agent memory consistency contract gate for EPIC-F08."""
...
DOC_PATH = Path("docs/MULTI_AGENT_MEMORY_CONSISTENCY.md")
...
def main() -> int:
    ...
    if returncode != 0:
        errors.append("multi_agent_consistency regression test failed")

    report = {
        "schema_version": "cortexdb.multi_agent_consistency.v1",
        "doc": str(DOC_PATH),
