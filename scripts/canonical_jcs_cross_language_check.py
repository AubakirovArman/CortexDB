...
try:
    from canonical_jcs_merkle import (
        ED25519_FIXTURE,
        ED25519_VECTORS,
        MERKLE_FIXTURE,
        MERKLE_VECTORS,
...
except ModuleNotFoundError:  # Allows `from scripts.canonical_jcs_cross_language_check import ...`.
    from scripts.canonical_jcs_merkle import (
        ED25519_FIXTURE,
        ED25519_VECTORS,
        MERKLE_FIXTURE,
        MERKLE_VECTORS,
