...
pub use repair::{
    ...
    ReplicationFollowerProgressStore, ReplicationRepairBackgroundHandle,
    ReplicationRepairBackgroundPolicy, ReplicationRepairBackgroundReport,
    ReplicationRepairCycleResult, ReplicationRepairDecision, ReplicationRepairDecisionKind,
    ReplicationRepairProgressSource, ReplicationRepairResult, ReplicationRepairSchedule,
    ReplicationRepairSnapshotSource, ReplicationRepairSweepResult, ReplicationRepairWorkerPolicy,
    ReplicationRepairWorkerReport, ReplicationRepairWorkerTick, ReplicationSnapshotRepairRequest,
    ReplicationSnapshotSendPolicy, ReplicationSnapshotSendResult, ReplicationSnapshotTransport,
