...
pub use embedding_pipeline::{
    ...
    embedding_expected_items_from_versions, embedding_ref_string,
    embedding_retry_ids_from_expected_items, embedding_retry_ids_from_jsonl, embedding_text_hash,
    metric_str, DeterministicTestEmbedder, Embedder, EmbeddingBackfillOptions,
    ...
    EmbeddingExpectedItem, EmbeddingProfile, QueryEmbeddingProvider,
...
pub use semantic_compression::{
    memory_class, CompressionSourcesReport, MemoryClass, RetireCompressionReport, RetiredSource,
    SemanticCompressionCandidate, SemanticCompressionCandidateGroup, SemanticCompressionReport,
    SemanticCompressionRequest, SemanticCompressionSourceRef,
};
