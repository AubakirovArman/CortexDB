//! Environment-configuration parsing for the server binary (moved from main.rs; behavior unchanged).
...
pub(crate) fn cluster_config_from_env() -> Result<Option<cortex_engine::ClusterConfig>, String> {
...
pub(crate) fn cluster_ingress_leader_from_env() -> Result<Option<cortex_engine::NodeId>, String> {
...
pub(crate) fn parse_cluster_ingress_leader(raw: &str) -> Result<cortex_engine::NodeId, String> {
    parse_positive_u64(raw, "CORTEXDB_CLUSTER_INGRESS_LEADER_ID").map(cortex_engine::NodeId)
}

pub(crate) fn cluster_ingress_max_in_flight_from_env() -> Result<usize, String> {
...
pub(crate) fn parse_cluster_ingress_max_in_flight(raw: &str) -> Result<usize, String> {
    parse_positive_usize(raw, "CORTEXDB_CLUSTER_INGRESS_MAX_IN_FLIGHT_PER_NODE")
}

pub(crate) fn auth_tokens_from_env() -> Result<Vec<cortex_server::AuthTokenPolicy>, String> {
...
pub(crate) fn parse_auth_tokens(raw: &str) -> Result<Vec<cortex_server::AuthTokenPolicy>, String> {
    cortex_server::parse_auth_tokens(raw)
        .map_err(|error| format!("invalid CORTEXDB_AUTH_TOKENS: {error}"))
}

pub(crate) fn auth_tokens_file_from_env() -> Result<Option<PathBuf>, String> {
...
pub(crate) fn auth_policy_store_file_from_env() -> Result<Option<PathBuf>, String> {
...
pub(crate) fn parse_auth_tokens_file_path(raw: &str) -> Result<PathBuf, String> {
...
pub(crate) fn parse_auth_policy_store_file_path(raw: &str) -> Result<PathBuf, String> {
    let trimmed = raw.trim();
    if trimmed.is_empty() {
...
pub(crate) fn audit_log_path_from_env() -> Result<Option<PathBuf>, String> {
...
pub(crate) fn parse_audit_log_path(raw: &str) -> Result<PathBuf, String> {
    let trimmed = raw.trim();
    if trimmed.is_empty() {
...
pub(crate) fn audit_log_rotate_bytes_from_env() -> Result<Option<u64>, String> {
    optional_positive_u64_from_env("CORTEXDB_AUDIT_LOG_ROTATE_BYTES")
}

pub(crate) fn audit_log_fsync_policy_from_env() -> Result<cortex_server::AuditLogFsyncPolicy, String>
{
...
pub(crate) fn parse_audit_log_fsync_policy(
    raw: &str,
) -> Result<cortex_server::AuditLogFsyncPolicy, String> {
...
pub(crate) fn audit_log_mac_key_from_env() -> Result<Option<cortex_server::AuditMacKey>, String> {
...
pub(crate) fn parse_audit_log_mac_key(
    key_id: &str,
    raw_key: &str,
...
pub(crate) fn receipt_signing_key_from_env(
) -> Result<Option<cortex_server::ReceiptSigningKey>, String> {
...
pub(crate) fn parse_receipt_signing_key(
    key_id: &str,
    raw_seed: &str,
...
pub(crate) fn parse_receipt_signing_key_file(
    path: &Path,
) -> Result<cortex_server::ReceiptSigningKey, String> {
...
pub(crate) fn parse_receipt_signing_key_file_json(
    raw: &str,
) -> Result<cortex_server::ReceiptSigningKey, String> {
...
pub(crate) fn receipt_external_signer_from_env(
) -> Result<Option<cortex_server::ReceiptExternalSigner>, String> {
...
pub(crate) fn parse_receipt_external_signer(
    command: &Path,
    key_id: &str,
    public_key_hex: &str,
...
pub(crate) fn parse_non_empty_path(raw: &str, name: &str) -> Result<PathBuf, String> {
    let trimmed = raw.trim();
    if trimmed.is_empty() {
...
pub(crate) fn auth_agent_id_from_env() -> Result<Option<u64>, String> {
...
pub(crate) fn parse_auth_agent_id(raw: &str) -> Result<u64, String> {
    parse_positive_u64(raw, "CORTEXDB_AUTH_AGENT_ID")
}

pub(crate) fn parse_positive_u64(raw: &str, name: &str) -> Result<u64, String> {
    let id = raw
        .parse::<u64>()
...
pub(crate) fn parse_positive_usize(raw: &str, name: &str) -> Result<usize, String> {
    let value = raw
        .parse::<usize>()
        .map_err(|_| format!("{name} must be a positive integer"))?;
    if value == 0 {
...
pub(crate) fn audit_log_enabled_from_env() -> bool {
...
pub(crate) fn llm_test_double_enabled_from_env() -> bool {
...
pub(crate) fn request_rate_limit_from_env() -> Result<Option<u64>, String> {
...
pub(crate) fn parse_request_rate_limit(raw: &str) -> Result<u64, String> {
    parse_positive_u64(raw, "CORTEXDB_RATE_LIMIT_PER_MINUTE")
}

pub(crate) fn route_timeout_from_env(var: &str, default_ms: u64) -> Result<u64, String> {
    match env::var(var) {
...
pub(crate) fn tenant_max_cells_from_env() -> Result<Option<u64>, String> {
    optional_positive_u64_from_env("CORTEXDB_TENANT_MAX_CELLS")
}

pub(crate) fn tenant_max_memory_bytes_from_env() -> Result<Option<u64>, String> {
    optional_positive_u64_from_env("CORTEXDB_TENANT_MAX_MEMORY_BYTES")
}

pub(crate) fn tenant_queue_quota_from_env() -> Result<Option<u64>, String> {
    optional_positive_u64_from_env("CORTEXDB_TENANT_QUEUE_QUOTA")
}

pub(crate) fn optional_positive_u64_from_env(var: &str) -> Result<Option<u64>, String> {
    match env::var(var) {
...
pub(crate) fn actor_queue_capacity_from_env() -> Result<usize, String> {
...
pub(crate) fn parse_actor_queue_capacity(raw: &str) -> Result<usize, String> {
