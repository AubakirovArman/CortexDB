...
use cortex_engine::{AnswerGroundingReport, CellMetadata, ContextPack, ContextPackCell};

use crate::responses::{AnswerGroundingReportResponse, AnswerGroundingSpanResponse};
...
pub(super) fn map_answer_grounding_report(
