(() => {
    ...
    function renderOperationalStatus(body) {
        ...
        details.replaceChildren(
            ...
            card("MemTable bytes", stats.estimated_memtable_bytes ?? "n/a"),
            card("Index bytes", stats.estimated_index_bytes ?? "n/a"),
            card("ContextPack bytes", stats.estimated_context_pack_bytes ?? "n/a"),
