...
- `crates/cortex-engine`: single-node database loop, incremental checkpoint, compaction, AQL-backed retrieve, AQL `REMEMBER`, memory TTL/decay, `VERIFY FACT` reports, ContextPack v0, search helpers with hybrid fusion, and consensus model primitives.
