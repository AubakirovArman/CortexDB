...
storage-soak-72h-status:
	python3 scripts/storage_soak_campaign_status.py --campaign "$(STORAGE_SOAK_V2_CAMPAIGN_REPORT)" --history "$(STORAGE_SOAK_V2_HISTORY_REPORT)" --target-hours "$(STORAGE_SOAK_V2_TARGET_HOURS)" --format "$(STORAGE_SOAK_CAMPAIGN_STATUS_FORMAT)"
