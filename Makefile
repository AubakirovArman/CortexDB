...
ENTERPRISE_RAG_BENCH_CURRENT_BEST ?= $(ENTERPRISE_RAG_BENCH_DOC_VIEW_V64)
ENTERPRISE_RAG_BENCH_CURRENT_DEPTH_REPORT ?= $(ENTERPRISE_RAG_BENCH_ROOT)/analysis/doc_view_v64_depth_report.json
ENTERPRISE_RAG_BENCH_CURRENT_DEPTH_DETAILS ?= $(ENTERPRISE_RAG_BENCH_ROOT)/analysis/doc_view_v64_depth_details.jsonl
ENTERPRISE_RAG_BENCH_CURRENT_DEPTH_MARKDOWN ?= $(ENTERPRISE_RAG_BENCH_ROOT)/analysis/doc_view_v64_depth_report.md
ENTERPRISE_RAG_BENCH_CURRENT_EVIDENCE_REPORT ?= $(ENTERPRISE_RAG_BENCH_ROOT)/analysis/evidence_pack_doc_view_v64_leading_report.json
ENTERPRISE_RAG_BENCH_CURRENT_EVIDENCE_DETAILS ?= $(ENTERPRISE_RAG_BENCH_ROOT)/analysis/evidence_pack_doc_view_v64_leading_details.jsonl
ENTERPRISE_RAG_BENCH_CURRENT_GATE_REPORT ?= $(ENTERPRISE_RAG_BENCH_ROOT)/analysis/local_calibration_gate_v64.json
ENTERPRISE_RAG_BENCH_CURRENT_GATE_MARKDOWN ?= $(ENTERPRISE_RAG_BENCH_ROOT)/analysis/local_calibration_gate_v64.md
ENTERPRISE_RAG_BENCH_CURRENT_COMPARISON_REPORT ?= $(ENTERPRISE_RAG_BENCH_ROOT)/analysis/v19_vs_v64_retrieval_comparison_report.json
ENTERPRISE_RAG_BENCH_CURRENT_COMPARISON_DETAILS ?= $(ENTERPRISE_RAG_BENCH_ROOT)/analysis/v19_vs_v64_retrieval_comparison_details.jsonl
ENTERPRISE_RAG_BENCH_CURRENT_COMPARISON_MARKDOWN ?= $(ENTERPRISE_RAG_BENCH_ROOT)/analysis/v19_vs_v64_retrieval_comparison_report.md
...
ENTERPRISE_RAG_BENCH_SOURCE_ROUTE_SWEEP_DIR ?= $(ENTERPRISE_RAG_BENCH_ROOT)/analysis/source_route_sweep_v64
ENTERPRISE_RAG_BENCH_SOURCE_ROUTE_SWEEP_REPORT ?= $(ENTERPRISE_RAG_BENCH_ROOT)/analysis/semantic_source_route_sweep_v64_report.json
ENTERPRISE_RAG_BENCH_SOURCE_ROUTE_SWEEP_MARKDOWN ?= $(ENTERPRISE_RAG_BENCH_ROOT)/analysis/semantic_source_route_sweep_v64_report.md
ENTERPRISE_RAG_BENCH_GOLD_MISSING_DETAILS ?= $(ENTERPRISE_RAG_BENCH_ROOT)/analysis/gold_missing_reasons_v64_details.jsonl
ENTERPRISE_RAG_BENCH_GOLD_MISSING_REPORT ?= $(ENTERPRISE_RAG_BENCH_ROOT)/analysis/gold_missing_reasons_v64_report.json
ENTERPRISE_RAG_BENCH_GOLD_MISSING_MARKDOWN ?= $(ENTERPRISE_RAG_BENCH_ROOT)/analysis/gold_missing_reasons_v64_report.md
ENTERPRISE_RAG_BENCH_GOLD_MISSING_BOTTLENECK_REPORT ?= $(ENTERPRISE_RAG_BENCH_ROOT)/analysis/gold_missing_bottlenecks_v64_report.json
ENTERPRISE_RAG_BENCH_GOLD_MISSING_BOTTLENECK_MARKDOWN ?= $(ENTERPRISE_RAG_BENCH_ROOT)/analysis/gold_missing_bottlenecks_v64_report.md
